...
namespace proyectoBuzon.Controllers
{
    public class ResolverController : Controller
    {
        ...
        //-----------------------------------------------------------------------------------------------
        public async Task<IActionResult> IndexQTecnico()
        {
        ...
        {
            //ViewData["IdQ"] = new SelectList(_context.Quejas
            //    .Where(q => q.IdQ == id)
            //    , "IdQ", "DescripcionQ");
            ...
            return View();
            var re = _context.Quejas.Find(id);
        }
        ...
        public async Task<IActionResult> Asignar([Bind("IdQuejatecnico,IdQ,IdTecnico,Fecha,Descripcion,IdQ,IdCl,IdTipoq,IdPolitica,IdPedido,IdEstado,DescripcionQ,FechaQ")] Quejatecnico quejatecnico, Quejas queja)
...

        {
            ...
            return RedirectToActionPreserveMethod("indexQTecnico", "Resolver");
            // var re = _context.Quejas.Find(id);
        }
