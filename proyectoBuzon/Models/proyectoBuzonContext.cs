...
namespace proyectoBuzon.Models
{
    public partial class proyectoBuzonContext : DbContext
    {
        ...
        public virtual DbSet<TblCliente> Tecnico { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Quejatecnico>(entity =>
            {
                entity.HasKey(e => e.IdQuejatecnico);

                entity.ToTable("quejatecnico");

                entity.HasIndex(e => e.IdQuejatecnico)
                    .HasName("i_id_queja_tecnico")
                    .IsUnique();
                ...
                entity.Property(e => e.IdQuejatecnico).HasColumnName("id_quejatecnico");
                ...
                entity.HasOne(d => d.IdTecnicoNavigation)
                    .WithMany(p => p.Quejatecnico)
                    .HasForeignKey(d => d.IdTecnico)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("fk_tecnico_reference_tecnico");

                entity.HasOne(d => d.IdQNavigation)
                    .WithMany(p => p.Quejatecnico)
                    .HasForeignKey(d => d.IdQ)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("fk_quejas_reference_quejas");
            });
            ...
            modelBuilder.Entity<Tecnico>(entity =>
            {
                ...
                entity.HasIndex(e => e.IdTecnico)
                    .HasName("i_id_tecnico")
                    .IsUnique();

                entity.Property(e => e.IdTecnico).HasColumnName("id_tecnico");

                entity.Property(e => e.ApellidosTecnico)
                    .IsRequired()
                    .HasColumnName("apellidos_tecnico")
                    .HasMaxLength(100);

                entity.Property(e => e.CedulaTecnico)
                    .IsRequired()
                    .HasColumnName("cedula_tecnico")
                    .HasMaxLength(100);
                ...
                entity.Property(e => e.NombresTecnico)
                    .IsRequired()
                    .HasColumnName("nombres_tecnico")
                    .HasMaxLength(100);

                entity.Property(e => e.TelefonoTecnico)
                    .IsRequired()
                    .HasColumnName("telefono_tecnico")
                    .HasMaxLength(100);
            });
        ...
        public DbSet<proyectoBuzon.Models.Tecnico> Tecnico_1 { get; set; }

        public DbSet<proyectoBuzon.Models.Quejatecnico> Quejatecnico { get; set; }
    }
}
